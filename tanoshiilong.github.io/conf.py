...
BLOG_AUTHOR = "とくめい"  # (translatable)
BLOG_TITLE = "楽しい世界"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://tanoshiilong.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://tanoshiilong.github.io/"
BLOG_EMAIL = "tanoshii@protonmail.com"
BLOG_DESCRIPTION = "私の楽しい世界"  # (translatable)
